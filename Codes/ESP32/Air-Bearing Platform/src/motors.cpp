...
{
    mcpwm_set_duty_in_us(MCPWM_UNIT_1, MCPWM_TIMER_2, MCPWM_OPR_A, dutyPwmMotor6);
}

void setMotorDirection()
{
    bool bit0 = rxMsg.msgs[whoAmI-1].msgMotorParameters.enableHBridges;
    bool bit1 = rxMsg.msgs[whoAmI-1].msgMotorParameters.directionMotor1;
    bool bit2 = rxMsg.msgs[whoAmI-1].msgMotorParameters.directionMotor2;
    bool bit3 = rxMsg.msgs[whoAmI-1].msgMotorParameters.directionMotor3;
    bool bit4 = rxMsg.msgs[whoAmI-1].msgMotorParameters.directionMotor4;
    bool bit5 = rxMsg.msgs[whoAmI-1].msgMotorParameters.directionMotor5;
    bool bit6 = rxMsg.msgs[whoAmI-1].msgMotorParameters.directionMotor6;
    bool bit7 = rxMsg.msgs[whoAmI-1].msgMotorParameters.reserved;
...
void setPwmAllMotors()
{
    if(rxMsg.msgs[whoAmI-1].msgMotorParameters.enableHBridges)
    {
        setPwmMotor1(rxMsg.msgs[whoAmI-1].msgDutyPwmMotor1);
        setPwmMotor2(rxMsg.msgs[whoAmI-1].msgDutyPwmMotor2);
        setPwmMotor3(rxMsg.msgs[whoAmI-1].msgDutyPwmMotor3);
        setPwmMotor4(rxMsg.msgs[whoAmI-1].msgDutyPwmMotor4);
        setPwmMotor5(rxMsg.msgs[whoAmI-1].msgDutyPwmMotor5);
        setPwmMotor6(rxMsg.msgs[whoAmI-1].msgDutyPwmMotor6);
        setMotorDirection();
    }
    else 
    {
