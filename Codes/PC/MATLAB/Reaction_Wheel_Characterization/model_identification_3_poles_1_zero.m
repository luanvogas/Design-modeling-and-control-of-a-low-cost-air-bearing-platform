function [Gm_iden,y] = model_identification_3_poles_1_zero(average_time, ...
                                                         average_ang_speed, ...
                                                         plot_enable)
    a = -1:0.5:1;
    b = -1:0.5:1;
    ...
    x0 = [best_a best_b best_c best_d];
    
    [x,fval] = fminsearch(@find_reaction_wheel_model_3_poles_1_zero,x0);
    ...
    Gm_iden = tf([a_iden 1],[b_iden c_iden d_iden 1]);
