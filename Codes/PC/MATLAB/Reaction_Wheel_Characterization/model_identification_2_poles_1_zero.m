function [Gm_iden,y] = model_identification_2_poles_1_zero(average_time, ...
                                                         average_ang_speed, ...
                                                         plot_enable)
    ...
    x0 = [best_a best_c best_d];
    
    [x,fval] = fminsearch(@find_reaction_wheel_model_2_poles_1_zero,x0);
    
    a_iden = x(1);
    c_iden = x(2);
    d_iden = x(3);
    
    Gm_iden = tf([a_iden 1],[c_iden d_iden 1]);
